...
const DistributorAccountCreated = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      }}>Dear distributor your account has been created successfully. Click on the button below to complete your
        profile</Text>
      ...
      <CustomButton
        ...
        onPress={() => {
          navigation.navigate("Login", { isDistributed });
        }}
        textContainerStyle={{
          color: "#fff",
        }} />
      ...
      <View style={{ width: 281, alignItems: "center", justifyContent: "center" }}>
        <Text style={{ color: "black", fontSize: 11, fontWeight: "400", textAlign: "center", lineHeight: 17.6 }}>By
          clicking, you acknowledge and agree to <Text onPress={() => Linking.openURL("http://netflix.com")}
...
export default DistributorAccountCreated;
