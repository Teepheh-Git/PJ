...
const ApplicationSubmitted = ({ navigation }) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      }}>Dear user your application has been submitted successfully. Check your dashboard from time to time to see the
        status of your application</Text>
