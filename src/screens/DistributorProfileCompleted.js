...
const DistributorProfileCompleted = ({ navigation }) => {
  return (
    <SafeAreaView style={styles.container}>
      ...
      }}>Dear distributor your profile has been completed successfully. Click on the button below to create a
        programme</Text>
...
export default DistributorProfileCompleted;
